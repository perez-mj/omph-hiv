...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository(['assets/' => ''], \dirname(__DIR__, 4), ['#^(?=[^\\.]).*.*/(?=[^\\.])assets/(?=[^\\.])styles/(?=[^\\.]).*.*/(?=[^\\.])_.*\\.scss$#'], true, true);
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DvCOUarQO0', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
