...
class getAssetMapper_Assets_Command_CompressService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['asset_mapper.assets.command.compress'] = $instance = new \Symfony\Component\AssetMapper\Command\CompressAssetsCommand(new \Symfony\Component\AssetMapper\Compressor\ChainCompressor(NULL, ($container->privates['logger'] ?? self::getLoggerService($container))));
